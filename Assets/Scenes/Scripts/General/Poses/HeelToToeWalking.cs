...
namespace Poses
{
    public class HeelToToeWalking : Pose
    {
        ...
        bool legCheck = false;
        public HeelToToeWalking(string repCount) : base(repCount) 
        { 
            name = "Heel To Toe Walking";

            // Set up Pose Classifier Processor
            processor = new PoseClassifierProcessor("Heel_To_Toe_Walking", true,8.5f,7.0f);
        }     
